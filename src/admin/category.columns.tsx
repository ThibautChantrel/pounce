...
import { MoreHorizontal, ArrowUpDown, Trash, Pencil, Tag } from 'lucide-react'
...
import { deleteCategoryAction } from '@/actions/category/category.admin.action'
...
const CategoryActions = ({ category }: { category: CategoryColumn }) => {
...
export const useCategoryColumns = () => {
  ...
  return useMemo<ColumnDef<CategoryColumn>[]>(
    () => [
      {
        accessorKey: 'value',
        header: t('value'),
